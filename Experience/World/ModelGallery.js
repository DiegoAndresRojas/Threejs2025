...
export default class ModelGallery 
{
    ...
    setupModels() {
        ...
        // Todos los modelos en el mismo lugar (origen sobre el piso)
        // El método setPosition ya ajusta automáticamente para que estén sobre el piso
    ...
    createNavigationButtons() {
        ...
        sliderLabel.textContent = 'Separar'
